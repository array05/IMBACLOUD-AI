...
> Уже есть VPS на ImbaCloud? Пока используйте [ручную установку](#быстрая-установка) ниже.  
> Новым клиентам скоро будет доступен переключатель **«IMBACLOUD AI Agent»** при заказе.
